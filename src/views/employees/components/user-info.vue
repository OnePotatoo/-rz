      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <ImageUpload ref="userImgRef"></ImageUpload>
            <!-- 放置上传图片 -->
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <ImageUpload ref="personRef"></ImageUpload>
        </el-form-item>
...
import { getPersonalDetail, getUserDetailById, saveUserDetailById, updatePersonal } from '@/api/employees'
export default {
  name: 'UserInfo',
  data () {
    return {
  ...
  methods: {
    async getUserDetailById () {
      ...
      // console.log(this.$refs.userImgRef.fileList)
      // console.log(this.userInfo.staffPhoto)
      this.$refs.userImgRef.fileList = [
        {
    ...
    async getPersonalDetail () {
      ...
      // console.log(this.$refs.personRef.fileList)
    ...
    async saveUser () {
      const fileList = this.$refs.userImgRef.fileList
